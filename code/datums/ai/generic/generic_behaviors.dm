...
/datum/ai_behavior/perform_emote/perform(delta_time, datum/ai_controller/controller, emote, speech_sound)
	var/mob/living/living_pawn = controller.pawn
	if(!istype(living_pawn))
		return
...
/datum/ai_behavior/perform_speech/perform(delta_time, datum/ai_controller/controller, speech, speech_sound)
	var/mob/living/living_pawn = controller.pawn
	if(!istype(living_pawn))
		return
