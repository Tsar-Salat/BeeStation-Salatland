...
/datum/action/cooldown/mob_cooldown/transform_weapon/proc/do_transform(atom/target)
	...
	var/obj/item/melee/transforming/cleaving_saw/miner/miner_saw = BDM.miner_saw
	...
	BDM.icon_state = "miner[miner_saw.active ? "_transformed":""]"
	BDM.icon_living = "miner[miner_saw.active ? "_transformed":""]"
