...
/datum/embed_data/proc/generate_with_values(embed_chance, fall_chance, pain_chance, pain_mult, max_damage_mult, remove_pain_mult, rip_time, ignore_throwspeed_threshold, jostle_chance, jostle_pain_mult, pain_stam_pct)
	...
	data.max_damage_mult = !isnull(max_damage_mult) ? max_damage_mult : src.max_damage_mult
