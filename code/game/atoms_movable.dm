...
/atom/movable/proc/Moved(atom/OldLoc, Dir, Forced = FALSE, list/OldLocs)
	...
	if(OldLoc)
		SEND_SIGNAL(OldLoc, COMSIG_ATOM_ABSTRACT_EXITED, src, Dir)
	if(loc)
		SEND_SIGNAL(loc, COMSIG_ATOM_ABSTRACT_ENTERED, src, OldLoc, OldLocs)
