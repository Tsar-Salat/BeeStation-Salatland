...
/turf/open/floor/mineral/titanium/alt/setup_broken_states()
	return list("titanium_dam1_alt","titanium_dam2_alt","titanium_dam3_alt","titanium_dam4_alt","titanium_dam5_alt")
