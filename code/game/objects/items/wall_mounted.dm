...
/obj/item/wallframe/wrench_act(mob/living/user, obj/item/tool)
	var/iron_amt = round(custom_materials[SSmaterials.GetMaterialRef(/datum/material/iron)]/SHEET_MATERIAL_AMOUNT) //Replace this shit later
	var/glass_amt = round(custom_materials[SSmaterials.GetMaterialRef(/datum/material/glass)]/SHEET_MATERIAL_AMOUNT) //Replace this shit later
