...
/obj/item/construction/rcd/arcd/debug
	...
	delay_mod = 0.1
	ranged = TRUE
	construction_upgrades = RCD_UPGRADE_FRAMES | RCD_UPGRADE_SIMPLE_CIRCUITS | RCD_UPGRADE_FURNISHING | RCD_UPGRADE_ANTI_INTERRUPT | RCD_UPGRADE_NO_FREQUENT_USE_COOLDOWN
	canRturf = TRUE
