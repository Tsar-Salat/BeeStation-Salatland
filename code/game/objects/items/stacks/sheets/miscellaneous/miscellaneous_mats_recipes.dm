...
GLOBAL_LIST_INIT(plastic_recipes, list(
	...
	new /datum/stack_recipe("water bottle", /obj/item/reagent_containers/cup/waterbottle/empty), \
	new /datum/stack_recipe("large water bottle", /obj/item/reagent_containers/cup/waterbottle/large/empty,3), \
