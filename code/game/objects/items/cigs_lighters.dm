...
/obj/item/clothing/mask/cigarette/afterattack(atom/target, mob/user, proximity)
	. = ..()
...
/obj/item/clothing/mask/vape/should_emag(mob/user) // I WON'T REGRET WRITING THIS, SURELY.
	if(!..())
		return FALSE
	if(!screw)
