...
/obj/item/food/meat/slab/make_processable()
	AddElement(/datum/element/processable, TOOL_KNIFE, list(/obj/item/food/meat/rawcutlet/plain), list(3), 30)
...
/obj/item/food/meat/slab/human/make_processable()
	AddElement(/datum/element/processable, TOOL_KNIFE, list(/obj/item/food/meat/rawcutlet/plain/human), list(3), 30)
...
/obj/item/food/meat/slab/killertomato/make_processable()
	AddElement(/datum/element/processable, TOOL_KNIFE, list(/obj/item/food/meat/rawcutlet/killertomato), list(3), 30)
...
/obj/item/food/meat/slab/bear/make_processable()
	AddElement(/datum/element/processable, TOOL_KNIFE, list(/obj/item/food/meat/rawcutlet/bear), list(3), 30)
...
/obj/item/food/meat/slab/xeno/make_processable()
	AddElement(/datum/element/processable, TOOL_KNIFE, list(/obj/item/food/meat/rawcutlet/xeno), list(3), 30)
...
/obj/item/food/meat/slab/spider/make_processable()
	AddElement(/datum/element/processable, TOOL_KNIFE, list(/obj/item/food/meat/rawcutlet/spider), list(3), 30)
...
/obj/item/food/meat/slab/gondola/make_processable()
	AddElement(/datum/element/processable, TOOL_KNIFE, list(/obj/item/food/meat/rawcutlet/gondola), list(3), 30)
...
/obj/item/food/meat/slab/penguin/make_processable()
	. = ..()
	AddElement(/datum/element/processable, TOOL_KNIFE, list(/obj/item/food/meat/rawcutlet/penguin), list(3), 30)
...
/obj/item/food/meat/slab/chicken/make_processable()
	. = ..()
	AddElement(/datum/element/processable, TOOL_KNIFE, list(/obj/item/food/meat/rawcutlet/chicken), list(3), 30)
