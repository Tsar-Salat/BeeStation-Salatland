...
/obj/item/food/raw_meatball/make_processable()
	AddElement(/datum/element/processable, TOOL_ROLLINGPIN, list(patty_type), list(1), 20)
...
/obj/item/food/sausage/make_processable()
	AddElement(/datum/element/processable, TOOL_KNIFE, list(/obj/item/food/salami), list(6), 3 SECONDS, table_required = TRUE,/*  screentip_verb = "Slice"*/)
	AddElement(/datum/element/processable, TOOL_KNIFE, list(/obj/item/food/sausage/american), list(1), 3 SECONDS, table_required = TRUE)
