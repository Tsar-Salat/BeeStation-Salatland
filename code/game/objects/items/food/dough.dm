...
/obj/item/food/dough/make_processable()
	AddElement(/datum/element/processable, TOOL_ROLLINGPIN, list(/obj/item/food/flatdough), list(1), 3 SECONDS, table_required = TRUE, /*screentip_verb = "Flatten"*/)
...
/obj/item/food/flatdough/make_processable()
	AddElement(/datum/element/processable, TOOL_KNIFE, list(/obj/item/food/doughslice), list(3), 3 SECONDS, table_required = TRUE, /*screentip_verb = "Slice"*/)
...
/obj/item/food/cakebatter/make_processable()
	AddElement(/datum/element/processable, TOOL_ROLLINGPIN, list(/obj/item/food/piedough), list(1), 3 SECONDS, table_required = TRUE, /*screentip_verb = "Flatten"*/)
...
/obj/item/food/piedough/make_processable()
	AddElement(/datum/element/processable, TOOL_KNIFE, list(/obj/item/food/rawpastrybase), list(6), 3 SECONDS, table_required = TRUE, /*screentip_verb = "Slice"*/)
