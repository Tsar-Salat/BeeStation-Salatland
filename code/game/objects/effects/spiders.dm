...
/obj/structure/spider/spiderling/netcaster
	grow_as = /mob/living/simple_animal/hostile/giant_spider/netcaster
...
/obj/structure/spider/spiderling/process()
	...
	if(isturf(loc))
		...
		if(amount_grown >= 100)
			if(!grow_as)
				if(prob(3))
					grow_as = pick(/mob/living/simple_animal/hostile/giant_spider/netcaster, /mob/living/simple_animal/hostile/giant_spider/hunter/viper, /mob/living/simple_animal/hostile/giant_spider/broodmother)
				else
