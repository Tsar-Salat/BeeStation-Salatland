...
/obj/item/gun/ballistic/shotgun/ctf
	...
	fire_sound = 'sound/weapons/shot_alt.ogg'
	semi_auto = TRUE
...
/obj/projectile/beam/instakill/on_hit(atom/target)
	...
	if(iscarbon(target))
		var/mob/living/carbon/target_mob = target
		target_mob.visible_message("span class='danger'[target_mob] explodes into a shower of gibs!</span>")
		target_mob.gib()
