...
/datum/action/spell/aoe/area_conversion/get_things_to_cast_on(atom/center)
...
/datum/action/spell/aoe/area_conversion/cast_on_thing_in_aoe(turf/victim, atom/caster)
