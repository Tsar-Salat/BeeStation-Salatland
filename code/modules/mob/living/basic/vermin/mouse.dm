/mob/living/basic/mouse
	...
	/// A list of diseases carried by this mouse.
	var/list/datum/disease/mouse_diseases = list()
...
/mob/living/basic/mouse/death(gibbed)
	...
	if(!gibbed)
		...
		mouse.mouse_diseases = mouse_diseases
...
/obj/item/food/deadmouse/attackby(obj/item/attacking_item, mob/user, params)
	...
	if(istype(living_user) && attacking_item.is_sharp() && living_user.combat_mode)
		if(!isturf(loc))
