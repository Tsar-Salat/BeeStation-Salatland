...
DEFINE_BUFFER_HANDLER(/obj/machinery/ticket_machine)
...
DEFINE_BUFFER_HANDLER(/obj/machinery/button/ticket_machine)
	if(!istype(buffer, /obj/machinery/ticket_machine))
		return NONE
