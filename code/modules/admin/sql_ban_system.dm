...
/datum/banning_panel/New()
	...
	if(!static_roles)
		static_roles = list(
			"command" = SSdepartment.get_jobs_by_dept_id(DEPARTMENT_COMMAND_NAME),
			"security" = SSdepartment.get_jobs_by_dept_id(DEPARTMENT_SECURITY_NAME),
			"engineering" = SSdepartment.get_jobs_by_dept_id(DEPARTMENT_ENGINEERING_NAME),
			"medical" = SSdepartment.get_jobs_by_dept_id(DEPARTMENT_MEDICAL_NAME),
			"science" = SSdepartment.get_jobs_by_dept_id(DEPARTMENT_SCIENCE_NAME),
			"supply" = SSdepartment.get_jobs_by_dept_id(DEPARTMENT_CARGO_NAME),
			"silicon" = SSdepartment.get_jobs_by_dept_id(DEPARTMENT_SILICON_NAME),
			"civilian" = SSdepartment.get_jobs_by_dept_id(DEPARTMENT_CIVILIAN_NAME),
...
/datum/admins/proc/old_ban_panel(player_key, player_ip, player_cid, role, duration = 1440, applies_to_admins, reason, edit_id, page, admin_key, global_ban = TRUE, force_cryo_after = FALSE)
	...
	if(edit_id)
		...
		for(var/job in SSdepartment.get_jobs_by_dept_id(DEPARTMENT_COMMAND_NAME))
		...
		var/list/job_lists = list("Security" = SSdepartment.get_jobs_by_dept_id(DEPARTMENT_SECURITY_NAME),
							"Engineering" = SSdepartment.get_jobs_by_dept_id(DEPARTMENT_ENGINEERING_NAME),
							"Medical" = SSdepartment.get_jobs_by_dept_id(DEPARTMENT_MEDICAL_NAME),
							"Science" = SSdepartment.get_jobs_by_dept_id(DEPARTMENT_SCIENCE_NAME),
							"Supply" = SSdepartment.get_jobs_by_dept_id(DEPARTMENT_CARGO_NAME))
		...
		var/list/headless_job_lists = list("Silicon" = SSdepartment.get_jobs_by_dept_id(DEPARTMENT_SILICON_NAME),
										"Abstract" = list("Appearance", "Emote", "OOC", "DSAY"))
		...
		var/list/long_job_lists = list(
			"Civilian" = SSdepartment.get_jobs_by_dept_id(DEPARTMENT_CIVILIAN_NAME) | JOB_NAME_GIMMICK,
