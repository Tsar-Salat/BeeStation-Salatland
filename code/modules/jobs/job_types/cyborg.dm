/datum/job/cyborg
	...
	department_for_prefs = DEPARTMENT_SILICON_NAME
...
/datum/job/cyborg/after_spawn(mob/living/spawned, client/player_client, client/preference_source, on_dummy = FALSE)
	. = ..()
	if(!iscyborg(spawned))
		return
