...
/datum/bounty/item/assistant/skateboard
	...
	wanted_types = list(/obj/vehicle/ridden/scooter/skateboard = TRUE, /obj/item/melee/skateboard = TRUE)

/datum/bounty/item/assistant/stunprod
	name = "Stunprod"
	description = "CentCom demands a stunprod to use against dissidents. Craft one, then ship it."
	reward = 1300
	wanted_types = list(/obj/item/melee/baton/cattleprod = TRUE)
...
/datum/bounty/item/assistant/briefcase
	...
	reward = 2500
	required_count = 5
	wanted_types = list(/obj/item/storage/briefcase = TRUE, /obj/item/storage/secure/briefcase = TRUE)
...
/datum/bounty/item/assistant/shard
	...
	reward = 1500
	required_count = 15
	wanted_types = list(/obj/item/shard = TRUE)
...
/datum/bounty/item/assistant/comfy_chair
	...
	reward = 1500
	required_count = 5
	wanted_types = list(/obj/structure/chair/fancy/comfy = TRUE)
