...
/datum/bounty/item/botany/forgetmenot
	...
	reward = 7000
	required_count = 3
	wanted_types = list(/obj/item/food/grown/flower/forgetmenot = TRUE)
...
/datum/bounty/item/botany/geranium
	...
	reward = 6000
	required_count = 3
	wanted_types = list(/obj/item/food/grown/flower/geranium = TRUE)
	format_exception = TRUE
...
/datum/bounty/item/botany/rainbowflowercrown
	...
	reward = 10000
	required_count = 3
	wanted_types = list(/obj/item/clothing/head/flowercrown/rainbowbunch = TRUE)
	format_exception = TRUE
