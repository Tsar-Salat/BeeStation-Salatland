/datum/codex_entry/structures
	category = CODEX_CATEGORY_STRUCTURES

/datum/codex_entry/structures/girder
...
/datum/codex_entry/structures/grille
...
/datum/codex_entry/structures/lattice
	associated_paths = list(/obj/structure/lattice)
	mechanics_text = "Add a floor tile to build a floor on top of the lattice.<br>\
	Lattices can be made by applying rods to a space tile."

/datum/codex_entry/structures/railing
	associated_paths = list(/obj/structure/railing)
	mechanics_text = "Use iron rods to build railings. <br>\
	Railings can be climbed over by anyone, and will block movement for mobs that aren't flying."

/datum/codex_entry/structures/bed
...
/datum/codex_entry/structures/chair
	associated_paths = list(/obj/structure/chair)
	mechanics_text = "Click and drag yourself (or anyone) to this to buckle in. Click on this with an empty hand to undo the buckles.<br>\
	<br>\
	Anyone with restraints, such as handcuffs, will not be able to unbuckle themselves. They must use the Resist button, or verb, to break free of \
	the buckles, instead."
