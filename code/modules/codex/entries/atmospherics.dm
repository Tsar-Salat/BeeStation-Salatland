/datum/codex_entry/atmospherics
	category = CODEX_CATEGORY_ATMOSPHERICS

/datum/codex_entry/atmospherics/atmos_pipe
...
//HE pipes
/datum/codex_entry/atmospherics/atmos_he
	associated_paths = list(/obj/machinery/atmospherics/pipe/heat_exchanging)
	mechanics_text = "This radiates heat from the pipe's gas to space, cooling it down."

//Supply/Scrubber pipes
/datum/codex_entry/atmospherics/atmos_scrub
	associated_paths = list(/obj/machinery/atmospherics/pipe/smart/simple/scrubbers)
...
/datum/codex_entry/atmospherics/atmos_supply
	associated_paths = list(/obj/machinery/atmospherics/pipe/smart/simple/supply)
	mechanics_text = "This is a special 'supply' pipe, which does not connect to 'normal' pipes.  If you want to connect it, use \
	a Universal Adapter pipe."

//Universal adapters
/datum/codex_entry/atmospherics/atmos_color_universal
	associated_paths = list(/obj/machinery/atmospherics/pipe/color_adapter)
	mechanics_text = "This allows you to connect 'normal' pipes, red 'scrubber' pipes, and blue 'supply' pipes."

/datum/codex_entry/atmospherics/atmos_layer_universal
	associated_paths = list(/obj/machinery/atmospherics/pipe/layer_manifold)
	mechanics_text = "This allows you to connect 'normal' layer 3 pipes, 'scrubber' layer 2 pipes, and 'supply' layer 4 pipes."

//Three way manifolds
/datum/codex_entry/atmospherics/atmos_manifold
...
/datum/codex_entry/atmospherics/atmos_manifold_scrub
	associated_paths = list(/obj/machinery/atmospherics/pipe/smart/manifold/scrubbers)
	mechanics_text = "This is a special 'scrubber' pipe, which does not connect to 'normal' pipes.  If you want to connect it, use \
	a Universal Adapter pipe."

/datum/codex_entry/atmospherics/atmos_manifold_supply
	associated_paths = list(/obj/machinery/atmospherics/pipe/smart/manifold/supply)
	mechanics_text = "This is a special 'supply' pipe, which does not connect to 'normal' pipes.  If you want to connect it, use \
	a Universal Adapter pipe."

//Four way manifolds
/datum/codex_entry/atmospherics/atmos_manifold_manifold_four
	associated_paths = list(/obj/machinery/atmospherics/pipe/smart/manifold4w)
	mechanics_text = "This is a four-way pipe."

/datum/codex_entry/atmospherics/atmos_manifold_manifold_four_scrub
	associated_paths = list(/obj/machinery/atmospherics/pipe/smart/manifold4w/scrubbers)
	mechanics_text = "This is a special 'scrubber' pipe, which does not connect to 'normal' pipes.  If you want to connect it, use \
	a Universal Adapter pipe."

/datum/codex_entry/atmospherics/atmos_manifold_manifold_four_supply
	associated_paths = list(/obj/machinery/atmospherics/pipe/smart/manifold4w/supply)
	mechanics_text = "This is a special 'supply' pipe, which does not connect to 'normal' pipes.  If you want to connect it, use \
	a Universal Adapter pipe."

//T-shaped valves
/datum/codex_entry/atmospherics/atmos_tvalve
	associated_paths = list(/obj/machinery/atmospherics/components/binary/pressure_valve)
	mechanics_text = "Click this to toggle the mode.  The direction with the green light is where the gas will flow."

//Normal valves
/datum/codex_entry/atmospherics/atmos_valve
...
//TEG ports
/datum/codex_entry/atmospherics/atmos_circulator
...
//Passive gates
/datum/codex_entry/atmospherics/atmos_gate
...
/datum/codex_entry/atmospherics/atmos_pump
...
//Vents
/datum/codex_entry/atmospherics/atmos_vent_pump
...
//Freezers
/datum/codex_entry/atmospherics/atmos_freezer
...
//Heaters
/datum/codex_entry/atmospherics/atmos_heater
...
//Gas injectors
/datum/codex_entry/atmospherics/atmos_injector
...
//Scrubbers
/datum/codex_entry/atmospherics/atmos_vent_scrubber
...
//Omni filters
/datum/codex_entry/atmospherics/atmos_omni_filter
	associated_paths = list(/obj/machinery/atmospherics/components/trinary/filter)
...
//Omni mixers
/datum/codex_entry/atmospherics/atmos_omni_mixer
	associated_paths = list(/obj/machinery/atmospherics/components/trinary/mixer)
	mechanics_text = "Combines gas from custom input and output directions.  The percentage of combined gas can be defined."

//Canisters
/datum/codex_entry/atmospherics/atmos_canister
...
//Portable pumps
/datum/codex_entry/atmospherics/atmos_power_pump
...
//Portable scrubbers
/datum/codex_entry/atmospherics/atmos_power_scrubber
...
/datum/codex_entry/atmospherics/gas_tank
...
/datum/codex_entry/atmospherics/gas_analyzer
