/datum/codex_entry
	var/display_name
	var/category = CODEX_CATEGORY_GENERIC
...
/datum/codex_entry/New(_display_name, _category, list/_associated_paths, list/_associated_strings, _lore_text, _mechanics_text, _antag_text)
