/datum/codex_entry/tools
	category = CODEX_CATEGORY_TOOLS

/datum/codex_entry/tools/wrench
...
/datum/codex_entry/tools/screwdriver
...
/datum/codex_entry/tools/wirecutters
...
/datum/codex_entry/tools/welder
	associated_paths = list(/obj/item/weldingtool)
	mechanics_text = "Use in your hand to toggle the welder on and off. Click on an object to try to weld it. You can seal airlocks, secure heavy-duty machines like emitters and disposal chutes, and repair damaged walls - these are only a few of its uses. Each use of the welder will consume a unit of fuel. Be sure to wear protective equipment such as goggles, a mask, or certain helmets to prevent eye damage. You can refill the welder with a welder tank by clicking on it, but be sure to turn it off first!"
...
/datum/codex_entry/tools/crowbar
...
/datum/codex_entry/tools/toolbelt
...
/datum/codex_entry/tools/paint_sprayer
	associated_paths = list(/obj/item/airlock_painter)
	mechanics_text = "<p>Used to paint floors, walls, windows, pipes, and airlocks.</p>\
...
/datum/codex_entry/tools/geiger_counter
...
/datum/codex_entry/tools/light_replacer
	associated_paths = list(/obj/item/lightreplacer)
	mechanics_text = "<p>Examine or use this item to see how many lights are remaining. You can feed it lightbulbs or sheets of glass to refill it."
...
/datum/codex_entry/tools/multitool
...
/datum/codex_entry/tools/t_scanner
...
/datum/codex_entry/tools/rcd
	associated_paths = list(/obj/item/construction/rcd)
	mechanics_text = "On use, this device will toggle between various types of structures (or their removal). Right-clicking with it will deconstruct most turfs its used on. It must be loaded with compressed matter cartridges, which can be obtained from a lathe. Click an adjacent tile to use the device."
...
/datum/codex_entry/tools/toolbox
