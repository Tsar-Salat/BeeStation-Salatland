...
/obj/item/reagent_containers/cup/glass/on_reagent_change(changetype)
	. = ..()
...
/obj/item/reagent_containers/cup/glass/mug/on_reagent_change(changetype)
	if(reagents.total_volume)
		icon_state = "tea"
	else
...
/obj/item/reagent_containers/cup/glass/beer
	name = "space beer"
	desc = "Beer. In space."
	icon_state = "beer"
...
/obj/item/reagent_containers/cup/glass/beer/almost_empty
	var/amount
	list_reagents = null

/obj/item/reagent_containers/cup/glass/beer/almost_empty/Initialize(mapload)
	. = ..()
	amount = rand(1,4)
	reagents.add_reagent(/datum/reagent/consumable/ethanol/beer, amount)

/obj/item/reagent_containers/cup/glass/syndicatebeer
	name = "syndicate beer"
...
/obj/item/reagent_containers/cup/glass/ftliver
...
/obj/item/reagent_containers/cup/glass/beer/light
	name = "Carp Lite"
	desc = "Brewed with \"Pure Ice Asteroid Spring Water\"."
	list_reagents = list(/datum/reagent/consumable/ethanol/beer/light = 30)

/obj/item/reagent_containers/cup/glass/ale
	name = "Magm-Ale"
...
/obj/item/reagent_containers/cup/glass/sillycup/on_reagent_change(changetype)
	if(reagents.total_volume)
...
/obj/item/reagent_containers/cup/glass/sillycup/smallcarton/on_reagent_change(changetype)
...
/obj/item/reagent_containers/cup/glass/honeycomb/attack_self(mob/user)
	if(!reagents.total_volume)
