...
/obj/item/reagent_containers/food/drinks/soda_cans/attack(mob/living/M, mob/living/user)
	if(M == user && !src.reagents.total_volume && user.combat_mode && user.is_zone_selected(BODY_ZONE_HEAD))
