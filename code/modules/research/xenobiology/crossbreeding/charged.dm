...
/obj/item/slimecross/charged/oil/proc/boom()
	explosion(src, devastation_range = 3, heavy_impact_range = 2, light_impact_range = 1, explosion_cause = src) //Much smaller effect than normal oils, but devastatingly strong where it does hit.
	qdel(src)
