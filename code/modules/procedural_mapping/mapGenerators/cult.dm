/datum/mapGeneratorModule/bottom_layer/cultFloor
...
/datum/mapGeneratorModule/bottom_layer/clockFloor
...
/datum/mapGenerator/cult //walls and floor only
	modules = list(/datum/mapGeneratorModule/bottom_layer/cultFloor, \
		/datum/mapGeneratorModule/border/cultWalls, \
...
/datum/mapGenerator/clock //walls and floor only
	modules = list(/datum/mapGeneratorModule/bottom_layer/clockFloor, \
		/datum/mapGeneratorModule/border/clockWalls, \
		/datum/mapGeneratorModule/bottom_layer/repressurize)
