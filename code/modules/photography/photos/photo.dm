...
/obj/item/photo/suicide_act(mob/living/carbon/user)
	...
	if (user.gender == MALE)
		playsound(user, 'sound/mobs/humanoids/human/manlaugh1.ogg', 50, 1)//EVERY TIME I DO IT MAKES ME LAUGH
	else if (user.gender == FEMALE)
		playsound(user, 'sound/mobs/humanoids/human/womanlaugh.ogg', 50, 1)
	return OXYLOSS
