...
/datum/cultural_info/culture/nabber
...
/datum/cultural_info/culture/nabber/get_formal_name_suffix()
	return title_suffix

/datum/cultural_info/culture/nabber/New()
	..()
...
/datum/cultural_info/culture/nabber/c
	name = CULTURE_NABBER_C
	valid_jobs = list(/datum/job/janitor)

/datum/cultural_info/culture/nabber/c/plus
	name = CULTURE_NABBER_CPLUS

/datum/cultural_info/culture/nabber/b
	name = CULTURE_NABBER_B
	valid_jobs = list(/datum/job/chef)

/datum/cultural_info/culture/nabber/b/minus
	name = CULTURE_NABBER_BMINUS

/datum/cultural_info/culture/nabber/b/plus
	name = CULTURE_NABBER_BPLUS

/datum/cultural_info/culture/nabber/a
	name = CULTURE_NABBER_A
	valid_jobs = list(/datum/job/chemist, /datum/job/roboticist)

/datum/cultural_info/culture/nabber/a/minus
	name = CULTURE_NABBER_AMINUS

/datum/cultural_info/culture/nabber/a/plus
