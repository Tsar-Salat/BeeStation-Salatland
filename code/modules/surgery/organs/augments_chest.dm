...
/obj/item/organ/cyberimp/chest/thrusters/Insert(mob/living/carbon/thruster_owner, special = 0, pref_load = FALSE)
	. = ..()
	if(!ion_trail)
		ion_trail = new
...
/obj/item/organ/cyberimp/chest/thrusters/Remove(mob/living/carbon/thruster_owner, special = 0, pref_load = FALSE)
	if(on)
		toggle(silent = TRUE)
	..()
