...
/atom/proc/on_mouse_enter(client/client)
	var/screentip_message = "\proper<span class='big' style='line-height: 0.5'>[MAPTEXT(CENTER(capitalize(name)))]</span>"
	var/datum/screentip_cache/cache = GLOB.screentips_cache["[type]"]
	if (cache)
#ifdef DEBUG
		screentip_message = "\proper<span class='big' style='line-height: 0.5'>[MAPTEXT(CENTER(capitalize(name) + "(Using Cache)"))]</span>"
#endif
