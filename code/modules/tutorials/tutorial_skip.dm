...
/atom/movable/screen/tutorial_skip/Initialize(mapload, datum/hud/hud_owner)
	...
	maptext = "<span style='font-family: \"VCR OSD Mono\"; font-size: 10px; text-align: left'>Remind me later</span>"
...
/atom/movable/screen/tutorial_skip_text/Initialize(mapload, datum/hud/hud_owner)
	. = ..()
	var/newtext = "<span style='font-family: \"VCR OSD Mono\"; font-size: 10px; text-align: left'>Remind me later</span>"
