...
/obj/eldritch/narsie/toddsie/greeting_message()
	...
	if(A)
		...
		notify_ghosts("Todd'Sie has risen in \the [A.name]. Reach out to the Geometer to be given a new shell for your soul.", source = src, alert_overlay = alert_overlay, action=NOTIFY_PLAY)
