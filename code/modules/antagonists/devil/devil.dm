...
/datum/antagonist/devil/proc/increase_arch_devil()
	...
	if(A)
		notify_ghosts("An arch devil has ascended in \the [A.name]. Reach out to the devil to be given a new shell for your soul.", source = owner.current, action=NOTIFY_PLAY)
	sleep(50)
