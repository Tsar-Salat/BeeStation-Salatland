...
/datum/reagent/consumable/milk/on_mob_life(mob/living/carbon/M, delta_time, times_fired)
	...
	if(M.has_reagent(/datum/reagent/consumable/capsaicin))
		M.remove_reagent(/datum/reagent/consumable/capsaicin, 1 * delta_time)
	..()
...
/datum/reagent/consumable/coffee/on_mob_life(mob/living/carbon/M, delta_time, times_fired)
	...
	if(M.has_reagent(/datum/reagent/consumable/frostoil))
		M.remove_reagent(/datum/reagent/consumable/frostoil, 5 * REM * delta_time)
	..()
	. = TRUE
...
/datum/reagent/consumable/hot_cocoa/on_mob_life(mob/living/carbon/M, delta_time, times_fired)
	...
	if(M.getBruteLoss() && DT_PROB(10, delta_time))
		...
		. = TRUE
	if(M.has_reagent(/datum/reagent/consumable/capsaicin))
		M.remove_reagent(/datum/reagent/consumable/capsaicin, 2 * REM * delta_time)
	..()
