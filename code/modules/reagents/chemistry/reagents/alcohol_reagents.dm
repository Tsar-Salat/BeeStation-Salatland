...
/datum/reagent/consumable/ethanol/reaction_mob(mob/living/exposed_mob, method=TOUCH, reac_volume)//Splashing people with ethanol isn't quite as good as fuel.
	. = ..()
