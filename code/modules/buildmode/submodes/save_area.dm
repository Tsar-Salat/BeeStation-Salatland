...
/datum/mapGenerator/save_area
	...
	modules = list(/datum/map_generator_module/save_area)
	var/min_x = 0
	var/min_y = 0
	var/max_x = 0
	var/max_y = 0

/datum/mapGenerator/save_area/define_region(turf/Start, turf/End, replace = 0)
...
/datum/map_generator_module/save_area
...
/datum/map_generator_module/save_area/generate()
