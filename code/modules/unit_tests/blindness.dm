...
/datum/unit_test/blindness/Run()
	...
	var/datum/quirk/blindness/quirk = allocate(/datum/quirk/blindness)
	quirk.transfer_mob(dummy)
	...
	dummy.mind.remove_quirk(/datum/quirk/blindness)
...
/datum/unit_test/nearsightedness/Run()
	...
	var/datum/quirk/nearsighted/quirk = allocate(/datum/quirk/nearsighted)
	quirk.transfer_mob(dummy)
	...
	dummy.mind.remove_quirk(/datum/quirk/nearsighted)
