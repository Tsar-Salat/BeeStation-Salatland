...
/obj/item/shuttle_creator/proc/check_area(list/turfs, addingTurfs = TRUE)
	...
	for(var/i in 1 to turfs.len)
		...
		if(!istype(t,/turf/open/floor/dock/drydock)) //Drydocks bypass the area check, but not the recursion check
			var/static/list/drydock_types = typesof(/turf/open/floor/dock/drydock, /turf/open/misc/grass, /turf/open/misc/dirt/planetary, /turf/open/misc/dirt/jungle/wasteland, /turf/open/floor/plating/beach/sand, /turf/open/misc/asteroid/planetary)
