...
SUBSYSTEM_DEF(accessories) // just 'accessories' for brevity
	...
	var/list/animated_tails_list_human
	var/list/tails_list_lizard
	var/list/animated_tails_list_lizard
...
/datum/controller/subsystem/accessories/proc/setup_lists()
	...
	animated_tails_list_human = init_sprite_accessory_subtypes(/datum/sprite_accessory/tails_animated/human)[DEFAULT_SPRITE_LIST]
	tails_list_lizard = init_sprite_accessory_subtypes(/datum/sprite_accessory/tails/lizard)[DEFAULT_SPRITE_LIST]
	animated_tails_list_lizard = init_sprite_accessory_subtypes(/datum/sprite_accessory/tails_animated/lizard)[DEFAULT_SPRITE_LIST]
	...
	animated_spines_list = init_sprite_accessory_subtypes(/datum/sprite_accessory/spines_animated)[DEFAULT_SPRITE_LIST]
...
/datum/controller/subsystem/accessories/proc/init_hair_gradients()
	...
	for(var/path in subtypesof(/datum/sprite_accessory/hair_gradient))
		var/datum/sprite_accessory/hair_gradient/gradient = new path()
