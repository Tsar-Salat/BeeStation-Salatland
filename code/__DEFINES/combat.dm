...
#define ARMOR_LIST_DAMAGE(...) list(BIO, RAD, BOMB, BULLET, ENERGY, LASER, MELEE, STAMINA)
...
#define ARMOR_LIST_ALL(...) list(ACID, BIO, RAD, BOMB, BULLET, CONSUME, ENERGY, FIRE, LASER, MELEE, STAMINA, /*WOUND*/)
