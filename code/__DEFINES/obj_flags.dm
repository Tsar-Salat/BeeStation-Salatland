...
#define MASKEXTENDRANGE			(1<<11) //! For masks, allows you to breathe from internals on adjecent tiles
#define NOTCONSUMABLE			(1<<12) //! Moths cannot eat clothing with that flag
#define HEADINTERNALS 			(1<<13) //! Headgear/helmet allows internals
