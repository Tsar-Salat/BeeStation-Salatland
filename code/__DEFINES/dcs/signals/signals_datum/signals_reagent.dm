...
///from base of atom/expose_reagents(): (/list, /datum/reagents, method, volume_modifier, show_message)
...
///from base of [/datum/reagent/proc/expose_atom]: (/mob/living, reac_volume, method, show_message, touch_protection, /mob/eye/blob) // ovemind arg is only used by blob reagents.
