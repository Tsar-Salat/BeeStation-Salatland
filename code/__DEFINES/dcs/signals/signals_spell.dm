...
/// Sent from /datum/action/spell/reset_spell_cooldown() to the spell: ()
#define COMSIG_SPELL_CAST_RESET "spell_cast_reset"

// Spell type signals

// Pointed projectiles
/// Sent from /datum/action/spell/pointed/projectile/on_cast_hit: (atom/hit, atom/firer, obj/projectile/source)
#define COMSIG_SPELL_PROJECTILE_HIT "spell_projectile_hit"

// AOE spells
/// Sent from /datum/action/spell/aoe/cast: (list/atoms_affected, atom/caster)
#define COMSIG_SPELL_AOE_ON_CAST "spell_aoe_cast"

// Cone spells
/// Sent from /datum/action/spell/cone/cast: (list/atoms_affected, atom/caster)
#define COMSIG_SPELL_CONE_ON_CAST "spell_cone_cast"
/// Sent from /datum/action/spell/cone/do_cone_effects: (list/atoms_affected, atom/caster, level)
#define COMSIG_SPELL_CONE_ON_LAYER_EFFECT "spell_cone_cast_effect"

// Touch spells
/// Sent from /datum/action/spell/touch/do_hand_hit: (atom/hit, mob/living/carbon/caster, obj/item/melee/touch_attack/hand)
