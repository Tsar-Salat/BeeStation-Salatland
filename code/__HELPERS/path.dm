...
/datum/pathfind/New(atom/movable/caller, atom/goal, id, max_distance, mintargetdist, simulated_only, avoid, avoid_mobs, skip_first, diagonal_safety, datum/callback/on_finish)
	src.caller = caller
	end = get_turf(goal)
