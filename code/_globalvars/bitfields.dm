...
// NOTE: BITFIELDS SHOULD BE SORTED ALPHABETICALLY, both by list & grouping. This is for organizational sake
//EXAMPLE
/*
DEFINE_BITFIELD(example, list(
	"IAMAEXAMPLE" = I_AM_A_EXAMPLE,
))
*/
